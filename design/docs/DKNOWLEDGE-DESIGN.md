...
Dknowledge é **o cérebro do sistema**. Não um segundo cérebro, não um espelho da
...
1. Leia o material extenso da organização antes de escrever schema: papers longos,
   documentos de arquitetura do Dk, material do Dknowledger local, e tudo que
...
como participar. O cofre local privado (Dknowledger) continua fora do público, como o
